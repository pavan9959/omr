...
defineFeature(feature, (test) => {
    ...
    test('User navigates to Wishlist2', ({ given, when, then }) => {
        let exampleBlockA:ShallowWrapper;
        let instance:Wishlist2; 

        given('I am a User loading Wishlist2', () => {
            exampleBlockA = shallow(<Wishlist2 {...screenProps}/>)
        });

        when('I navigate to the Wishlist2', () => {
             instance = exampleBlockA.instance() as Wishlist2
        });
