...
const feature = loadFeature('./__tests__/features/CameraAccess-scenario.feature');
...
defineFeature(feature, (test) => {
    ...
    test('User navigates to CameraAccess', ({ given, when, then }) => {
        ...
        given('I am a User loading CameraAccess', () => {
            exampleBlockA = shallow(<CameraAccess {...screenProps}/>)
        });

        when('I navigate to the CameraAccess', () => {
             instance = exampleBlockA.instance() as CameraAccess
        });
