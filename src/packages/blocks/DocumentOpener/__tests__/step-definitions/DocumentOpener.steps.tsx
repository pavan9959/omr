...
const feature = loadFeature('./__tests__/features/DocumentOpener-scenario.feature');
...
defineFeature(feature, (test) => {
    ...
    test('User navigates to DocumentOpener', ({ given, when, then }) => {
        ...
        given('I am a User loading DocumentOpener', () => {
            exampleBlockA = shallow(<DocumentOpener {...screenProps}/>)
        });

        when('I navigate to the DocumentOpener', () => {
             instance = exampleBlockA.instance() as DocumentOpener
        });
