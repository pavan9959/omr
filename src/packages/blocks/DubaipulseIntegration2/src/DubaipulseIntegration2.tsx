...
import DubaipulseIntegration2Controller, {
  Props,
  configJSON
} from "./DubaipulseIntegration2Controller";

export default class DubaipulseIntegration2 extends DubaipulseIntegration2Controller {
