...
import DubaiLandDepartmentdldApi2Controller, {
  Props,
  configJSON
} from "./DubaiLandDepartmentdldApi2Controller";

export default class DubaiLandDepartmentdldApi2 extends DubaiLandDepartmentdldApi2Controller {
