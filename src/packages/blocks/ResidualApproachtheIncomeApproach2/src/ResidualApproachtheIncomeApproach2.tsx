...
import ResidualApproachtheIncomeApproach2Controller, {
  Props,
  configJSON
} from "./ResidualApproachtheIncomeApproach2Controller";

export default class ResidualApproachtheIncomeApproach2 extends ResidualApproachtheIncomeApproach2Controller {
