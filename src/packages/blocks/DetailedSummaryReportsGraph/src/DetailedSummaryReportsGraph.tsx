...
import DetailedSummaryReportsGraphController, {
  Props,
  configJSON
} from "./DetailedSummaryReportsGraphController";

export default class DetailedSummaryReportsGraph extends DetailedSummaryReportsGraphController {
