...
import GeolocationReportingController, {
  Props,
  configJSON
} from "./GeolocationReportingController";

export default class GeolocationReporting extends GeolocationReportingController {
