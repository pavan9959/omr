...
import DetailedSummaryReportWithoutAi3Controller, {
  Props,
  configJSON
} from "./DetailedSummaryReportWithoutAi3Controller";

export default class DetailedSummaryReportWithoutAi3 extends DetailedSummaryReportWithoutAi3Controller {
