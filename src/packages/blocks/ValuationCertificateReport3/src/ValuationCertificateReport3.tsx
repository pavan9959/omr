...
import ValuationCertificateReport3Controller, {
  Props,
  configJSON
} from "./ValuationCertificateReport3Controller";

export default class ValuationCertificateReport3 extends ValuationCertificateReport3Controller {
