...
import InvestmentDiscountedCashFlowdcfTheIncomeApproach2Controller, {
  Props,
  configJSON
} from "./InvestmentDiscountedCashFlowdcfTheIncomeApproach2Controller";

export default class InvestmentDiscountedCashFlowdcfTheIncomeApproach2 extends InvestmentDiscountedCashFlowdcfTheIncomeApproach2Controller {
