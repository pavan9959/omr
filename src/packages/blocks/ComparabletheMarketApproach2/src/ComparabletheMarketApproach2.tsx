...
import ComparabletheMarketApproach2Controller, {
  Props,
  configJSON
} from "./ComparabletheMarketApproach2Controller";

export default class ComparabletheMarketApproach2 extends ComparabletheMarketApproach2Controller {
