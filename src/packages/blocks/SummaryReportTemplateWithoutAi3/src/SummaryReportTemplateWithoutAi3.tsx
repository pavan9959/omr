...
import SummaryReportTemplateWithoutAi3Controller, {
  Props,
  configJSON
} from "./SummaryReportTemplateWithoutAi3Controller";

export default class SummaryReportTemplateWithoutAi3 extends SummaryReportTemplateWithoutAi3Controller {
