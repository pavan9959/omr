...
import DepreciatedReplacementCostcontractors2Controller, {
  Props,
  configJSON
} from "./DepreciatedReplacementCostcontractors2Controller";

export default class DepreciatedReplacementCostcontractors2 extends DepreciatedReplacementCostcontractors2Controller {
