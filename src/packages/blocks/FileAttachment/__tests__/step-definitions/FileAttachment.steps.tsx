...
const feature = loadFeature('./__tests__/features/FileAttachment-scenario.feature');
...
defineFeature(feature, (test) => {
    ...
    test('User navigates to FileAttachment', ({ given, when, then }) => {
        ...
        let instance:FileAttachment; 

        given('I am a User loading FileAttachment', () => {
            exampleBlockA = shallow(<FileAttachment {...screenProps}/>)
        });

        when('I navigate to the FileAttachment', () => {
             instance = exampleBlockA.instance() as FileAttachment
        });
